...
## Offline-first
På grund av tekniska svårigheter, har jag valt att genom en extern javascript fil utföra så kallad "polling" mot servern, för att fastställa statusen på anslutningen. Ifall användaren inte är ansluten, görs upprepade försök att ansluta och användaren meddelas att hen arbetar offline. Knappen för att göra nya sökningar blir även avaktiverad. 
